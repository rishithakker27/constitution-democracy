...
\authorcontributions{R.T.\ designed the study, constructed the constitutional typology, built and trained all models, and wrote the paper.}
\authordeclaration{The author declares no competing interests. Code, data, and replication materials are available at \href{https://github.com/rishithakker27/constitution-democracy}{github.com/rishithakker27/constitution-democracy} (AI chat transcripts included). Project website: \href{https://portfolio-eight-lilac-55.vercel.app}{portfolio-eight-lilac-55.vercel.app}.}
\correspondingauthor{\textsuperscript{1}Correspondence: rishi.thakker.27@dartmouth.edu}

\keywords{Constitutional design $|$ Democratic backsliding $|$ Machine learning $|$ De facto constitutionalism $|$ V-Dem}

\begin{abstract}
Constitutional text is the \emph{de jure} face of democracy: it records what a polity formally promises about political competition, individual rights, and governmental structure. Democratic performance, as measured by V-Dem's Polyarchy index, is the \emph{de facto} reality. How much does the former predict the latter? We address this question by scoring 17,390 country-years spanning 1789--2023 on 14 constitutional dimensions using an LLM-assisted typology applied to the Comparative Constitutions Project (CCPCNC v5), then training a gradient-boosted model (CatBoost) with country-blocked five-fold cross-validation to predict Polyarchy from constitutional features alone. The answer is stark: a fold-average $R^2$ of just $0.10$ on entirely held-out countries indicates that constitutional regimes have very limited power to explain how democratic governance actually plays out. A country's rulebook, however well designed, predicts remarkably little about the democracy its citizens actually experience. Among the provisions that do carry signal, the rankings challenge the Madisonian tradition: Political Competition (10.7\%), Institutional Accountability (9.2\%), and Civil Liberties (8.7\%) are the top predictors, while the classical separation-of-powers safeguards---Executive Constraints (6.8\%), Judicial Independence (5.1\%), and Legislative Autonomy (4.5\%)---rank in the bottom half. Notably, constitutional text has been evolving in this direction since the 1900s: rights and accountability provisions have expanded most globally, while separation-of-powers provisions have been essentially flat. We construct a \emph{constitutional gap}---the signed difference between constitutionally implied and actually achieved democracy---and show it is widest in newer constitutions and in regimes where democratic norms have not yet consolidated, while countries with older constitutional orders consistently outperform their text, suggesting that de facto democratic capacity takes decades to build.
\end{abstract}
...
A constitution is the rulebook of government: the foundational document that defines who holds power, how it may be exercised, and what it may never do. For more than two centuries, political theorists in the Madisonian tradition have argued that getting the rulebook right is the primary safeguard of democratic liberty---that separated powers, an independent judiciary, and constrained executives will produce democratic governance by making the abuse of authority structurally costly. Constitution-writers from Cairo to Beirut have followed this blueprint, encoding judicial independence and executive constraints into documents drafted in the wake of authoritarian collapse or civil conflict. Yet democracy has not reliably followed. The central puzzle is the gap between the de jure rulebook and de facto political reality: a constitution can mandate competitive elections and guarantee civil liberties while the state enforces neither. This paper provides the first large-$n$ machine learning test of how much the rulebook actually predicts the reality---and which provisions in it do the most work.
...
\caption{The 14 Constitutional Dimensions: descriptions and example CCPCNC variables. Ranked by CatBoost feature importance (Polyarchy target).}
\label{tab:dimensions}
\begin{tabular}{clp{3.8cm}p{3.8cm}}
\textbf{Rank} & \textbf{Dimension} & \textbf{Description} & \textbf{Example CCPCNC Variables} \\
\midrule
1  & Political Competition         & Competitive multi-party elections, universal suffrage, rights to form parties & Multi-party system, universal suffrage, right to form parties \\
2  & Institutional Accountability  & Audit institutions, ombudsman, legislative oversight of executive action & Independent audit body, ombudsman, anti-corruption commission \\
3  & Civil Liberties               & Individual freedoms of expression, assembly, religion, and movement & Freedom of speech, assembly, religion, movement \\
4  & Emergency Powers Constraints  & Limits on states of emergency: declaration, duration, rights suspension & Legislative approval required, duration limits, non-derogable rights \\
5  & Civilian Control of Security  & Military and police under civilian authority & Civilian commander-in-chief, legislative approval of deployment \\
6  & Transparency / Info Access    & Right to government information and press freedom protections & Right to information, freedom of press, open government \\
7  & Rule of Law / Due Process     & Fair trial rights, habeas corpus, due process & Right to counsel, presumption of innocence, prohibition of torture \\
8  & Federalism / Decentralization & Powers distributed between central and sub-national governments & Regional governments, devolution of powers, fiscal federalism \\
9  & Executive Constraints         & Formal limits on executive authority & Term limits, veto override, approval requirements \\
10 & Amendment Rigidity            & Barriers to constitutional modification & Supermajority requirements, referendum, unamendable provisions \\
11 & Judicial Independence         & Judicial autonomy through tenure, appointment, and removal provisions & Security of tenure, independent appointment, jurisdictional protection \\
12 & Socioeconomic Rights          & Positive rights to economic and social goods & Right to education, health, housing, labour rights \\
13 & Legislative Autonomy          & Parliamentary independence from executive control & Legislative immunity, committee powers, budget authority \\
14 & Equality                      & Non-discrimination for gender, minorities, and indigenous groups & Gender equality, minority protections, indigenous rights \\
\bottomrule
\end{tabular}
\end{table*}
...
The low ranking of Executive Constraints, Judicial Independence, and Legislative Autonomy reflects a fundamental asymmetry in constitutional politics: these provisions are among the easiest to write symbolically but among the hardest to enforce in practice. Any government can insert a clause limiting executive power or requiring judicial independence---authoritarian constitutions do so routinely \cite{ginsburg_simpser_2014}. What makes such provisions meaningful is not their presence in the text but the surrounding architecture of enforcement: independent bar associations, political parties with genuine autonomy, civil society capable of monitoring compliance, and elite acceptance that these constraints are legitimate. In the absence of those extra-textual conditions, the provisions are simply ignored. Political Competition and Institutional Accountability provisions are harder to adopt insincerely: a constitution that genuinely mandates competitive elections creates observable, verifiable commitments that are more costly to circumvent without visible violation. The feature rankings thus reflect not which provisions matter most for democracy in theory, but which carry the most information in practice---a distinction between what can be written cheaply and what requires real political costs to adopt.

Figure~\ref{fig:shap} shows the corresponding SHAP beeswarm plot: for the top-ranked dimensions, higher constitutional scores (red points) shift predictions rightward, confirming that the relationship between provision strength and predicted democracy is broadly monotonic rather than driven by outliers.
...
\begin{minipage}{0.48\linewidth}
  ...
  \caption{CatBoost feature importances for the Polyarchy model. Blue = rights and equality; green = checks and balances; red = backsliding protections. Classical Madisonian provisions rank in the bottom half.}
  \label{fig:feat_imp}
\end{minipage}
\hfill
\begin{minipage}{0.48\linewidth}
  \centering
  \includegraphics[width=\linewidth]{shap_beeswarm_polyarchy.png}
  \caption{SHAP beeswarm plot for the Polyarchy model. Each point is a country-year observation; colour indicates feature value (red = high, blue = low). Rightward shift indicates a positive contribution to predicted democracy.}
  \label{fig:shap}
\end{minipage}
\end{figure}
...
\centering
\includegraphics[width=\linewidth]{constitution_inflation.png}
...
The most natural interpretation is that what makes constitutions effective is not the text but what grows up around it over time: the judicial conventions, legislative customs, and civil society expectations that enforce democratic behavior whether or not the written document requires it. New constitutions have not yet had time to develop that culture. Their actual democratic performance reflects not inadequate drafting but the absence of the institutional ecology that gives constitutional text its force---and the gap between text and reality is widest precisely when countries need their constitutions most, in the early years of a transition when democratic norms are fragile and enforcement is weakest.

% ---------------------------------------------------------------
\section*{How Constitutional Provisions Have Evolved}

The 14 dimension scores reveal what constitution-writers have prioritized across history. \begin{wrapfigure}{r}{0.46\linewidth}
\vspace{-6pt}
\centering
\includegraphics[width=\linewidth]{dimension_change_bar.png}
\caption{\small Absolute change in global average constitutional dimension scores, 1900s--2020s.}
\label{fig:dim_change}
\vspace{0pt}
\end{wrapfigure}

Tracking each dimension's global average from the 1900s to the 2020s (Figure~\ref{fig:dim_change}), the dimensions that have grown most are Socioeconomic Rights ($+0.31$), Equality ($+0.20$), Civil Liberties ($+0.17$), and Rule of Law / Due Process ($+0.17$); the classical Madisonian architecture---Executive Constraints ($+0.02$), Legislative Autonomy ($+0.004$), Emergency Powers ($\approx 0$)---has been essentially flat. This helps explain the feature importance results: separation-of-powers dimensions vary so little across constitutions that they carry limited discriminating power for the model, while the rights and competition provisions that have expanded most are precisely those that are harder to adopt insincerely.
...
\section*{Reflection on Agentic Coding Workflow}

One of the most productive aspects of this project was using an agentic coding environment to rapidly iterate through analytical hypotheses that would have taken days to test manually. Because the model pipeline was fully scripted and modular, I could explore and discard ideas within a single session---testing different cross-validation strategies, lead-lag specifications, region-based similarity models, and KNN approaches, among others. Some of these analyses made it into the final paper; others, where results proved inconclusive, were set aside. The ability to conduct many different types of analysis quickly, review outputs, and make principled decisions about what belonged in the paper was the clearest practical benefit of the agentic workflow.

A second major benefit was the ease of analyzing and interpreting results. At each stage of the pipeline, the agentic environment helped surface patterns in the outputs---flagging anomalous folds, comparing feature importance rankings across model specifications, and identifying which country cases drove the largest gaps. This accelerated the interpretive work considerably, turning what would otherwise be a slow manual inspection of CSVs and figures into a more fluid back-and-forth between code, output, and analysis.

Perhaps the most concrete structural benefit was modularity. The main CatBoost pipeline was built once and written in a way that made it trivial to swap in different outcome variables. Running the identical model against all five V-Dem democracy concepts---Electoral, Liberal, Egalitarian, Participatory, and Deliberative---required minimal additional code and produced the comparative results reported in Table~\ref{tab:robustness}. The same modular logic applied to the robustness checks, the culture extension, and the lead-lag specifications: each was a targeted variation on the core pipeline rather than a from-scratch implementation. This kind of reuse would have been possible without an agentic environment, but the workflow made it natural to structure code that way from the start.

That said, the agentic workflow had real limitations. The most visible, as the code in the GitHub repository reflects, is a tendency toward overcomplication. Functions and pipelines that could have been written simply were sometimes over-engineered---additional abstraction layers, redundant intermediate files, and verbose logic that made the codebase harder to read and maintain than it needed to be. This occasionally created friction when revisiting earlier notebooks to make targeted changes, since untangling the logic took longer than it would have with cleaner code. A more disciplined approach to simplicity---writing the minimum viable implementation first and only adding complexity when genuinely needed---would have made the project easier to audit and extend.
